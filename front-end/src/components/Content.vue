<template>
  <div id="Content">
    ...
    >
      ...
      <span slot="footer" class="dialog-footer">请耐心等待几秒钟</span>
    </el-dialog>
    ...
    <div id="CT">
      ...
      <div id="info_patient">
        <!-- 卡片放置表格 -->
        <el-card style="border-radius: 8px; margin-left: 173px">
          ...
          <el-tabs v-model="activeName">
            <el-tab-pane label="检测到的目标" name="first">
              ...
              <el-table
                ...
                height="390"
                border
                style="width: 1157px; text-align: center"
                v-loading="loading"
                element-loading-text="数据正在处理中，请耐心等待"
                element-loading-spinner="el-icon-loading"
                lazy
              >
                <el-table-column label="目标类别" width="385px">
                  <template slot-scope="scope">
                    <span>{{ scope.row[2] }}</span>
                  </template>
                </el-table-column>
                <el-table-column label="目标大小" width="385px">
                  <template slot-scope="scope">
                    <span>{{ scope.row[0] }}</span>
                  </template>
                </el-table-column>
                <el-table-column label="置信度" width="385px">
                  <template slot-scope="scope">
